...
impl SparkService {
    ...
    pub async fn send_spark_transaction(
        ...
        let public_key_package = self
            .frost_aggregator
            .get_public_key_package(issuer_id.clone(), None)
            .await
        ...
        let partial_token_transaction_hash = token_transaction
            .hash()
        ...
        let signing_metadata = create_signing_metadata(token_transaction, transaction_type.clone(), true);
