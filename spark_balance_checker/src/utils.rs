...
pub(crate) mod decode_spark_address {
    use super::{Network, ServerError, eyre::Result};
    use bech32::Bech32m;
    use hex;
    ...
    pub(crate) fn decode_spark_address(addr: String) -> Result<SparkAddressData, ServerError> {
        // -----------------------------------------------------------------
