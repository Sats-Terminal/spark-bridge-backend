...
pub const SPARK_CREATION_ENTITY_PUBLIC_KEY: [u8; 33] = [
    0x02, 0x05, 0xFE, 0x80, 0x7E, 0x8F, 0xE1, 0xF3, 0x68, 0xDF, 0x95, 0x5C,
    0xC2, 0x91, 0xF1, 0x6D, 0x84, 0x0B, 0x7F, 0x28, 0x37, 0x4B, 0x0E, 0xD8,
    0x0B, 0x80, 0xC3, 0xE2, 0xE0, 0x92, 0x1A, 0x06, 0x74,
];
